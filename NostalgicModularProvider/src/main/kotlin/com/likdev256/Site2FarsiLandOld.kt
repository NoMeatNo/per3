...
/**
 * Site 2: FarsiLand Old Content (farsiland.com)
 * Handles old Iranian series and movies from FarsiLand.
 */
class Site2FarsiLandOld(override val api: MainAPI) : SiteHandler {
    override val siteUrl = "https://farsiland.com"
    override val siteName = "FarsiLand Old"
    
    override val mainPages = listOf(
        "$siteUrl/iranian-series/" to "📺 Old Iranian Series - $siteName",
        "$siteUrl/old-iranian-movies/" to "🎬 Old Iranian Movies - $siteName",
    )
