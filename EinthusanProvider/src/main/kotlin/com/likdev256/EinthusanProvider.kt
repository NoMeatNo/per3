...
class EinthusanProvider : MainAPI() { // all providers must be an instance of MainAPI
    ...
    private fun Element.toSearchResult(): SearchResponse? {
        ...
        val href = this.selectFirst("div.movie-title h3 a")?.absUrl("href") ?: return null
        val posterUrl = this.selectFirst("div.latest-movie-img-container img")?.absUrl("src") ?: return null
